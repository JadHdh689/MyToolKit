  ...
  `).join("");i.innerHTML=`
    ...
    <div class="modal-book-header">
      ...
      <div class="modal-book-info">
        ...
        <div class="modal-age-range"><strong>Age Range:</strong> ${j(e.id)}</div>
      </div>
    </div>
